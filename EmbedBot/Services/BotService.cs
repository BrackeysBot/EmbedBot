...
using EmbedBot.Commands;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Logging;

namespace EmbedBot.Services;
...
internal sealed class BotService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _logger.LogInformation("EmbedBot v{Version} is starting", Version);
        ...
        slashCommands.RegisterCommands<EmbedCommand>();
