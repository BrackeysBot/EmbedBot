...
[SlashRequireGuild]
internal sealed class EmbedCommand : ApplicationCommandModule
{
        ...
        DiscordChannel? channel = null)
    {
        ...
        DiscordModalTextInput titleInput =
            modal.AddInput("Title", "The title of the embed.", maxLength: 256, isRequired: true);
        DiscordModalTextInput colorInput = modal.AddInput("Color", "e.g. #007EC6", maxLength: 7, isRequired: false);
        DiscordModalTextInput descriptionInput = modal.AddInput("Description", "The body of the embed.",
            isRequired: true, maxLength: 2048, inputStyle: TextInputStyle.Paragraph);
